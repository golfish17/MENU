...
def conversion_angulos():
    ...
    ventana_conv.config(bg="deepskyblue")
    tk.Label(ventana_conv, text="Seleccione la conversión:", bg="deepskyblue").pack()
    ...
    for i, opcion in enumerate(opciones, 1):
        tk.Radiobutton(ventana_conv, text=opcion, variable=var_opcion, value=i, bg="deepskyblue").pack(anchor="w")
    tk.Label(ventana_conv, text="Ingrese el ángulo:", bg="deepskyblue").pack()
    entry_angulo = tk.Entry(ventana_conv)
    entry_angulo.pack()
    lbl_resultado = tk.Label(ventana_conv, text="Resultado: ", bg="deepskyblue")
    lbl_resultado.pack()
...
def area_perimetro_cuadrado():
    ...
    ventana.config(bg="chartreuse")
    tk.Label(ventana, text="Ingrese el lado del cuadrado:", bg="chartreuse").pack()
    entry_lado = tk.Entry(ventana)
    entry_lado.pack()
    lbl_resultado = tk.Label(ventana, text="Resultado: ", bg="chartreuse")
    lbl_resultado.pack()
...
def area_perimetro_triangulo():
    ...
    tk.Label(ventana, text="Ingrese la base del triángulo:", bg="tomato").pack()
    entry_base = tk.Entry(ventana)
    entry_base.pack()
    tk.Label(ventana, text="Ingrese la altura del triángulo:", bg="tomato").pack()
    entry_altura = tk.Entry(ventana)
    entry_altura.pack()
    tk.Label(ventana, text="Ingrese el primer lado del triángulo:", bg="tomato").pack()
    entry_lado1 = tk.Entry(ventana)
    entry_lado1.pack()
    tk.Label(ventana, text="Ingrese el segundo lado del triángulo:", bg="tomato").pack()
    entry_lado2 = tk.Entry(ventana)
    entry_lado2.pack()
    lbl_resultado = tk.Label(ventana, text="Resultado: ", bg="tomato")
    lbl_resultado.pack()
    tk.Button(ventana, text="Calcular", command=calcular).pack(pady=5)
...
def area_perimetro_trapecio():
    ...
    tk.Label(ventana, text="Ingrese la base mayor del trapecio:", bg="orange").pack()
    entry_base_mayor = tk.Entry(ventana)
    entry_base_mayor.pack()
    tk.Label(ventana, text="Ingrese la base menor del trapecio:", bg="orange").pack()
    entry_base_menor = tk.Entry(ventana)
    entry_base_menor.pack()
    tk.Label(ventana, text="Ingrese la altura del trapecio:", bg="orange").pack()
    entry_altura = tk.Entry(ventana)
    entry_altura.pack()
    tk.Label(ventana, text="Ingrese el primer lado del trapecio:", bg="orange").pack()
    entry_lado1 = tk.Entry(ventana)
    entry_lado1.pack()
    tk.Label(ventana, text="Ingrese el segundo lado del trapecio:", bg="orange").pack()
    entry_lado2 = tk.Entry(ventana)
    entry_lado2.pack()
    lbl_resultado = tk.Label(ventana, text="Resultado: ", bg="orange")
    lbl_resultado.pack()
    tk.Button(ventana, text="Calcular", command=calcular).pack(pady=5)
...
def area_perimetro_circulo():
    ...
    ventana.config(bg="mediumvioletred")
    tk.Label(ventana, text="Ingrese el radio del círculo:", bg="mediumvioletred").pack()
    entry_radio = tk.Entry(ventana)
    entry_radio.pack()
    lbl_resultado = tk.Label(ventana, text="Resultado: ", bg="mediumvioletred")
    lbl_resultado.pack()
    tk.Button(ventana, text="Calcular", command=calcular).pack(pady=5)


# Interfaz de inicio y ejecución principal
...
def ejecutar_con_interfaz():
    ...
    def ejecutar_menu():
        ...
        ventana_menu.config(bg="darkslategray")
        tk.Label(ventana_menu, text="*** MENÚ PRINCIPAL ***", font=("Arial", 16), bg="darkslategray").pack(pady=10)
        botones = [
    ...
    tk.Label(root, text="Sistema protegido", font=("Arial", 16), bg="lavenderblush").pack(pady=20)
